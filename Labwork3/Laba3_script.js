...
//змінна типу string
let exampleString1 = "оголошення в подвійних лапках";
let exampleString2 = 'оголошення в одинарних лапках';
...
console.log(`Машина з мінімальним об'ємом двигуна: ${minEngineCar.model}`);
...
console.log("Слово у зворотньому порядку: " + reversedWord);